...
CREATE TABLE class_schedule (
    ...
    class_id INTEGER NOT NULL, -- check no. range?
    staff_id INTEGER NOT NULL, -- check no. range?
    start_time DATETIME NOT NULL, -- check not after end_time?
    end_time DATETIME NOT NULL, -- check not before start_time?
...
CREATE TABLE memberships (
    ...
    type VARCHAR[7] NOT NULL CHECK(type IN ('Basic', 'Premium')), -- Extra checks added
    start_date DATE NOT NULL, -- check not after end_time?
    end_date DATE NOT NULL, -- check not before start_time?
...
CREATE TABLE member_health_metrics (
    ...
    body_fat_percentage REAL NOT NULL, -- CHECK 1 DECIMAL PLACES?
