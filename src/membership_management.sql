...
SELECT type AS membership_type, AVG(unixepoch(check_out_time) - unixepoch(check_in_time))/60 AS avg_visit_duration_minutes
FROM attendance
...
SELECT members.member_id, first_name, last_name, email, end_date
FROM memberships 
